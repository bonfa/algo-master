package it.fbonfadelli.algo.master.arrays.ui

import it.fbonfadelli.algo.master.arrays.exercises.*
...
object ArrayMenuPrinter {
    ...
    fun execute() {
        ...
        println("[10] - First Missing Positive")
        println()
